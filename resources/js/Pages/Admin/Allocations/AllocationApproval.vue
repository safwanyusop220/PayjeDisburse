...
const rejectAllocation = async (id) => {
    ...
    try {
        form.post(route("allocations.reject", props.allocation?.id), {
            onSuccess: (page) => {
                Toast.fire({
                    icon: "success",
...
<template>
    <Head title="Allocation Approval" />
                ...
                <div class="flex justify-between pt-6">
                    <nav class="text-sm font-semibold" aria-label="Breadcrumb">
                        <ol class="list-none p-0 inline-flex">
                            ...
                            <li class="flex items-center">
                                <BreadcrumbActive :href="route('allocations.waitingApproval')">Waiting Approval</BreadcrumbActive>
                            </li>
                            <li class="flex items-center">
