    ...
    <nav class="fixed top-0 z-50 w-full bg-white border-b border-gray-200">
        <div class="px-3 py-3 lg:px-5 lg:pl-3">
            ...
            <div class="flex items-center justify-start">
                ...
                <McBankFill class="bg-primary-300 text-3xl rounded cursor-pointer block float-left duration-500"/>
                <span class="self-center text-lg font-semibold sm:text-2xl whitespace-nowrap dark:text-white ml-3">PayjeDisburse</span>
            </div>
