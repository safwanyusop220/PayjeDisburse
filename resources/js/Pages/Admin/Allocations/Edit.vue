            ...
            <div class="w-full mx-auto">
                ...
                <Content>
                    <form @submit.prevent="submit">
                        <div>
                            <InputLabel for="allocation_source" value="Allocation Source" />
                            <TextInput
                        ...
                        <!--Bank/Account Number-->
                        <div class="row mt-2">
                            <div class="col grid grid-cols-2 space-x-6">
                                <div>
                                ...
                                <div>
                                    <InputLabel for="allocation_balance" value="Bank Type" />
                                    <div class="col-span-3">
                                        <select class="mt-1 rounded-md text-xs border border-gray-300 w-4/5" v-model="form.bank" id="refBank">
                        ...
                        <!--Total Allocation/Allocation Balance-->
                        <div class="row mt-2">
                            <div class="col grid grid-cols-2 space-x-6">
                                <div>
                                    <InputLabel for="total_allocation" value="Total Allocation" />
                                    <div class="relative mb-6">
                                        <div class="absolute text-xs inset-y-0 left-0 flex items-center pl-3.5 pointer-events-none">
                                            RM
                                        </div>
                                        <TextInput
                                            id="total_allocation"
                                            type="number"
                                            class="mt-1 pl-9 block w-full"
                                ...
                                <div>
                                    <InputLabel for="allocation_balance" value="Allocation Balance" />
                                    <div class="relative mb-6">
                                        <div class="absolute text-xs inset-y-0 left-0 flex items-center pl-3.5 pointer-events-none">
                                            RM
                                        </div>
                                        <TextInput
                                            ...
                                            type="number"
                                            class="mt-1 pl-9 block w-full"
                                            v-model="form.allocation_balance"
                                            :value="form.allocation_balance"
                                            autofocus
                                            autocomplete="username"
                                        />
                                    </div>

                                    <InputError class="mt-2" :message="form.errors.allocation_balance" />
                                </div>
                            </div>
                        </div>
                        <!--Button-->
