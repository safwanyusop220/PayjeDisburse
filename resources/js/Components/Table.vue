...
<template>
    <div class="relative overflow-x-auto rounded-lg">
        ...
        <hr class="font-bold">
        <!--<nav class="bg-gray-100 flex items-center justify-between pt-4" aria-label="Table navigation">
            <span class="ml-5 mb-3 text-sm font-normal text-gray-500 dark:text-gray-400">Showing <span
                    class="font-semibold text-gray-900 dark:text-white">1-10</span> of <span
                    class="font-semibold text-gray-900 dark:text-white">1000</span></span>
            <ul class="mr-5 mb-3 inline-flex -space-x-px text-sm h-8">
                <li>
                    <a href="#"
